...
setEmailid(e.target.value);
    ...
    <br/><span><span id='customer' >Customer Care</span><br/> <br/>Order Tracking<br/><br/>Privacy Policy<br/><br/>Payments & Returns<br/><br/>FAQs</span>
        ...
        <span id='media-icons'>
        <a href="https://www.linkedin.com/in/mithlesh-kumar-0b91bb254"><IoLogoLinkedin className='media'/></a>
       <a href="https://www.instagram.com/adarsh__172/" ><RiInstagramFill className='media'/></a>
      <a href="https://twitter.com/Mithles79073500" > <FaTwitterSquare className='media'/></a> 
       <a href="https://github.com/AdarshSingh172" > <ImGithub className='media'/></a>
        </span>
        <br/>
